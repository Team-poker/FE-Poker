  ...
  return (
      <>
        ...
        <div className="button-modal" onClick={() => setActiveModal(true)}>
          <Button className="button-link" text="Start new game" />
        </div>
        <Modal active={activeModal} setActive={setActiveModal}>
          ...
          <form className="form__modal" onSubmit={sendData}>
            ...
            <label>
              ...
              <Button className="button__modal" text="Load file" />
            </span>
            </label>
            ...
            >
              ...
              <div onClick={() => setActiveModal(false) }>
                <WhiteButton text="Cancel" classNane="span__modal" type="button" />
              </div>
            </div>
          </form>
        </Modal>
